    ...
    if($Result->num_rows > 0){
        while ($Row = $Result->fetch_assoc()){
            ...
            <div class="w3-container">
                <h3 style="height:77px;overflow:hidden;position: relative;"><b>' . $PostTitle . '</b></h3>
...
function DisplayPostsTag($TagID) {
    ...
    if ($Result->num_rows > 0) {
        ...
        echo '<div class="w3-margin w3-white"><div class="w3-container"><h3>Sorry! Nothing to see here. No Posts!</h3></div></div>';
    }
}
...
function DisplayComments($PostID) {
    ...
    if ($Result->num_rows > 0) {
        while ($Row = $Result->fetch_assoc()) {
            ...
            $Comment       = $Row['Comment'];
            echo '<h5><b>Recent Comments</b></h5>';
            echo '
    ...
    if ($Result->num_rows > 0) {
        while ($Row = $Result->fetch_assoc()) {
            ...
            echo '<li class="w3-padding-16">
                    ...
                    <span class="w3-large"><a style="text-decoration: none;" href="' . $slug . '">' . $PostTitle . '</a></span>
                    <br>
