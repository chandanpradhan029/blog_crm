...
<div id="page-wrapper">
                ...
                <div class="white-box">
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input name="PostTitle" type="text" class="form-control rounded" placeholder="Post Title"
                                required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="PostSlug" type="text" class="form-control rounded" placeholder="Post Slug"
                                required>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="FeatureImage" title="Feature Image" id="Feature Image" type="file"
                        ...
                        <div class="form-group">
                            <input type="date" class="form-control" id="custdate" name="custdate" required="">
                        </div>

                        <div class="form-group">
                            <button name="AddPost" type="submit" class="input-md btn btn-success waves-effect">Add
                                Post</button>
                        </div>
    ...
    <footer class="footer text-center">
        <?php echo date('Y'); ?> &copy; Travelmagica All Right Resorved
    </footer>
</div>
<!-- ============================================================== -->
<!-- End Page Content -->
